...
class TestNode(unittest.TestCase):
    ...
    def test_node_send_data_str(self):
        ...
        self.assertTrue(
            len(messages) > 0, "There should have been sent some messages around!"
        )
        self.assertEqual(
            len(messages), 23, "There should have been sent 23 message around!"
        )

        self.assertEqual(
            messages[0], "mytestnode started", "MyTestNode should have seen this event!"
        )
        self.assertEqual(
            messages[1], "mytestnode started", "MyTestNode should have seen this event!"
        )
        self.assertEqual(
            messages[2], "mytestnode started", "MyTestNode should have seen this event!"
        )
