...
class TestNode(unittest.TestCase):
    ...
    def test_node_connection(self):
        ...
        self.assertEqual(
            step_1_node1_total_inbound_nodes,
            0,
            "The node 1 should not have any inbound nodes.",
        )
        self.assertEqual(
            step_1_node1_total_outbound_nodes,
            0,
            "The node 1 should not have any outbound nodes.",
        )
        self.assertEqual(
            step_1_node2_total_inbound_nodes,
            0,
            "The node 2 should not have any inbound nodes.",
        )
        self.assertEqual(
            step_1_node2_total_outbound_nodes,
            0,
            "The node 2 should not have any outbound nodes.",
        )

        self.assertEqual(
            step_2_node1_total_inbound_nodes,
            0,
            "The node 1 should not have any inbound nodes.",
        )
        self.assertEqual(
            step_2_node1_total_outbound_nodes,
            0,
            "The node 1 should not have any outbound nodes.",
        )
        ...
        self.assertEqual(
            ...
            0,
            "The node 1 should not have any inbound node.",
        )
        self.assertEqual(
            step_3_node1_total_outbound_nodes,
            1,
            "The node 1 should have one outbound nodes.",
        )
        self.assertEqual(
            step_3_node2_total_inbound_nodes,
            1,
            "The node 2 should have one inbound node.",
        )
        self.assertEqual(
            step_3_node2_total_outbound_nodes,
            0,
            "The node 2 should not have any outbound nodes.",
        )
    ...
    def test_node_complete(self):
        ...
        if step_1_node_0_total_connections > 0:
            step_1_node_0_connection_node = (
                node_0_connections[0].id
                + ":"
                + node_0_connections[0].host
                + ":"
                + str(node_0_connections[0].port)
            )  # node1.id:127.0.0.1:10001
        ...
        if step_1_node_1_total_connections > 0:
            step_1_node_1_connection_node = (
                node_1_connections[0].id + ":" + node_1_connections[0].host
            )  # node0.id:127.0.0.1, inbound port is port of client
        ...
        if step_2_node_2_total_connections > 0:
            step_2_node_2_connection_node = (
                ...
                + ":"
                + node_2_connections[0].host
                + ":"
                + str(node_2_connections[0].port)
            )  # node0.id:127.0.0.1:10000
        ...
        if step_2_node_0_total_connections > 0:
            step_2_node_0_connection_node = (
                node_0_connections[0].id + ":" + node_0_connections[0].host
            )  # node2.id:127.0.0.1
        ...
        # Perform the asserts!
        self.assertEqual(
            step_1_node_0_total_connections,
            1,
            "Node 0 should have one outbound connection.",
        )
        self.assertEqual(
            step_1_node_0_connection_node,
            node_1.id + ":127.0.0.1:10001",
            "Node 0 should be connected (outbound) with node 1.",
        )
        self.assertEqual(
            step_1_node_1_total_connections,
            1,
            "Node 1 should have one inbound connection.",
        )
        self.assertEqual(
            step_1_node_1_connection_node,
            node_0.id + ":127.0.0.1",
        ...
        self.assertEqual(
            step_2_node_2_total_connections,
            1,
            "Node 2 shoud have one outbound connection.",
        )
        self.assertEqual(
            step_2_node_2_connection_node,
            node_0.id + ":127.0.0.1:10000",
            "Node 2 should be connected (outbound) with node 0.",
        )
        self.assertEqual(
            step_2_node_0_total_connections,
            1,
            "Node 0 should have one inbound connection.",
        )
        self.assertEqual(
            step_2_node_0_connection_node,
            node_2.id + ":127.0.0.1",
        ...
        self.assertTrue(
            len(message) > 0, "There should have been sent some messages around!"
        )
        self.assertTrue(
            len(message) == 4, "There should have been sent 4 message around!"
        )
        self.assertEqual(
            message[0],
            "node_message:" + node_2.id + ":" + node_0.id + ":hello from node 0",
            "Node 2 should have received a message from node 0",
        )
        self.assertEqual(
            message[1],
            "node_message:" + node_1.id + ":" + node_0.id + ":hello from node 0",
            "Node 1 should have received a message from node 0",
        )
        self.assertEqual(
            message[2],
            "node_message:" + node_0.id + ":" + node_1.id + ":hello from node 1",
            "Node 0 should have received a message from node 1",
        )
        self.assertEqual(
            message[3],
            "node_message:" + node_0.id + ":" + node_2.id + ":hello from node 2",
    ...
    def test_node_events(self):
        ...
        self.assertTrue(
            len(message) == 11, "There should have been sent 4 message around!"
        )

        if "outbound" in message[0]:
            self.assertEqual(
                message[0],
                "outbound_node_connected:" + node_0.id,
                "Event should have occurred",
            )
            self.assertEqual(
                message[1],
                "inbound_node_connected:" + node_1.id,
                "Event should have occurred",
            )
        else:
            self.assertEqual(
        ...
        if "outbound" in message[2]:
            self.assertEqual(
                message[2],
                "outbound_node_connected:" + node_2.id,
                "Event should have occurred",
            )
            self.assertEqual(
                message[3],
                "inbound_node_connected:" + node_0.id,
                "Event should have occurred",
            )
        else:
            self.assertEqual(
        ...
        if node_2.id in message[4]:
            self.assertEqual(
                message[4], "node_message:" + node_2.id, "Event should have occurred"
            )
            self.assertEqual(
                message[5], "node_message:" + node_1.id, "Event should have occurred"
            )
        else:
            self.assertEqual(
                message[5], "node_message:" + node_2.id, "Event should have occurred"
            )
            self.assertEqual(
                message[4], "node_message:" + node_1.id, "Event should have occurred"
            )

        self.assertEqual(
            message[6], "node_message:" + node_0.id, "Event should have occurred"
        )
        self.assertEqual(
            message[7], "node_message:" + node_0.id, "Event should have occurred"
        )
        self.assertEqual(
            message[8],
            "node_request_to_stop:" + node_0.id,
            "Event should have occurred",
        )
        self.assertEqual(
            message[9],
            "node_request_to_stop:" + node_1.id,
            "Event should have occurred",
        )
        self.assertEqual(
            message[10],
            "node_request_to_stop:" + node_2.id,
            "Event should have occurred",
        )
    ...
    def test_extending_class_of_node(self):
        ...
        self.assertTrue(
            len(message) == 14, "There should have been sent 14 message around!"
        )

        self.assertEqual(
            message[0], "mytestnode started", "MyTestNode should have seen this event!"
        )
        self.assertEqual(
            message[1], "mytestnode started", "MyTestNode should have seen this event!"
        )
        self.assertEqual(
            message[2], "mytestnode started", "MyTestNode should have seen this event!"
        )
        ...
        self.assertEqual(
            message[7],
            "node_message from " + node1.id + ": hello from node 1",
            "MyTestNode should have seen this event!",
        )
        self.assertEqual(
            message[8],
        ...
        self.assertEqual(
            message[9],
            "node_message from " + node2.id + ": hello from node 2",
            "MyTestNode should have seen this event!",
        )
        self.assertEqual(
            message[10],
            "node_message from " + node3.id + ": hello from node 3",
            "MyTestNode should have seen this event!",
        )
    ...
    def test_node_max_connections(self):
        ...
        node_0 = Node(
            host="127.0.0.1", port=10000, callback=node_callback, max_connections=1
        )  # max connection of 1
        node_1 = Node(
            host="127.0.0.1", port=10001, callback=node_callback, max_connections=2
        )  # max connection of 2
        node_2 = Node(host="127.0.0.1", port=10002, callback=node_callback)
        ...
        # Perform the asserts!
        self.assertEqual(
            len(node_0.nodes_inbound),
            1,
            "More inbound connections have been accepted bij node_0!",
        )
        self.assertEqual(
            len(node_1.nodes_inbound),
            2,
            "Node 1 should have two connections from node_0 and node_2!",
        )
        self.assertEqual(
            len(node_2.nodes_outbound),
            1,
            "Node 2 should have one outbound connection with node_1!",
        )
    ...
    def test_node_id(self):
        ...
        node_0 = Node(
            host="127.0.0.1", port=10000, id="thisisanidtest", callback=node_callback
        )
        node_1 = Node(host="127.0.0.1", port=10001, callback=node_callback)
        ...
        # Perform the asserts!
        self.assertEqual(
            node_0.id, "thisisanidtest", 'Node 0 shoud have id "thisisanidtest"'
        )
        self.assertNotEqual(
            node_1.id, "thisisanidtest", "Node 1 should have a different id than node 0"
        )
        self.assertNotEqual(
            node_1.id, None, "The ID pf node 1 should not be equal to None"
        )
