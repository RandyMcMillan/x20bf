...
from gitdb.test.lib import make_memory_file, skip_on_travis_ci, with_rw_directory
    ...
    def test_large_data_streaming(self, path):
        ...
        for randomize in range(2):
            ...
            print(
                ...
                % (size_kib, desc, elapsed_readall, size_kib / (elapsed_readall or 1)),
                file=sys.stderr,
            )
            ...
            print(
                ...
                % (
                    ...
                    cs_kib,
                    elapsed_readchunks,
                    size_kib / (elapsed_readchunks or 1),
                ),
                file=sys.stderr,
            )
