import pytest
from torpy.consesus import DirectoryFlags, DirectoryServer, RouterFlags
...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            {
                "_nickname": "moria1",
                "_fingerprint": b"\x96\x95\xdf\xc3_\xfe\xb8a2\x9b\x9f\x1a\xb0LF9p \xce1",
                "_digest": None,
                "_ip": "128.31.0.39",
                "_or_port": 9101,
                "_dir_port": 9131,
                "_version": None,
                "_flags": [RouterFlags.Authority],
                "_consensus": None,
                "_service_key": None,
                "_dir_flags": DirectoryServer.AUTH_FLAGS,
                "_v3ident": "D586D18309DED4CD6D57C18FDB97EFA96D330566",
                "_ipv6": None,
                "_bridge": False,
            },
        ),
        (
            ...
            {
                "_nickname": "tor26",
                "_fingerprint": b"\x84{\x1f\x85\x03D\xd7\x87d\x91\xa5H\x92\xf9\x04\x93NN\xb8]",
                "_digest": None,
                "_ip": "86.59.21.38",
                "_or_port": 443,
                "_dir_port": 80,
                ...
                "_service_key": None,
                "_dir_flags": DirectoryServer.AUTH_FLAGS,
                "_v3ident": "14C131DFC5C6F93646BE72FA1401C02A8DF2E8B4",
                "_ipv6": "[2001:858:2:2:aabb:0:563b:1526]:443",
                "_bridge": False,
            },
        ),
        (
            ...
            {
                "_nickname": "dizum",
                "_fingerprint": b"~\xa6\xea\xd6\xfd\x83\x08<S\x8fD\x03\x8b\xbf\xa0wX}\xd7U",
                "_digest": None,
                "_ip": "45.66.33.45",
                "_or_port": 443,
                "_dir_port": 80,
                ...
                "_service_key": None,
                "_dir_flags": DirectoryServer.AUTH_FLAGS,
                "_v3ident": "E8A9C45EDE6D711294FADF8E7951F4DE6CA56B58",
                "_ipv6": None,
                "_bridge": False,
            },
        ),
        (
            ...
            {
                "_nickname": "Serge",
                "_fingerprint": b"\xbaD\xa8\x89\xe6K\x93\xfa\xa2\xb1\x14\xe0,*'\x9a\x85U\xc53",
                "_digest": None,
                "_ip": "66.111.2.131",
                "_or_port": 9001,
                "_dir_port": 9030,
                ...
                "_consensus": None,
                "_service_key": None,
                "_dir_flags": DirectoryFlags.BRIDGE_DIRINFO,
                "_v3ident": None,
                "_ipv6": None,
                "_bridge": True,
            },
        ...
        (
            ...
            {
                "_nickname": "gabelmoo",
                "_fingerprint": b"\xf2\x04D\x13\xda\xc2\xe0.=k\xcfG5\xa1\x9b\xca\x1d\xe9r\x81",
                "_digest": None,
                "_ip": "131.188.40.189",
                "_or_port": 443,
                "_dir_port": 80,
                ...
                "_service_key": None,
                "_dir_flags": DirectoryServer.AUTH_FLAGS,
                "_v3ident": "ED03BB616EB2F60BEC80151114BB25CEF515B226",
                "_ipv6": "[2001:638:a000:4140::ffff:189]:443",
                "_bridge": False,
            },
        ),
    ],
    ids=["moria1", "tor26", "dizum", "Serge", "gabelmoo"],
)
